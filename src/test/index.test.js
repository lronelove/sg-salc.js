...
function test() {
	assert.equal(sg_calc.start(0.1).add(0.2).end(), 0.3, '测试1')
	assert.equal(sg_calc.start(0.1).add(0.2).multiply(3).end(), 0.9, '测试2')
	assert.equal(sg_calc.start(0.3).minus(3).end(), -2.7, '测试3')
	assert.equal(sg_calc.start(0.2).multiply(0.4).add(1).end(), 1.08, '测试4')
	console.log(sg_calc.add(0.1, 2.0000000000000000e-7), 'yes')
}
